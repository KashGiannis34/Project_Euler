package Problems;//Largest product in a series
import java.util.Objects;
import java.util.Scanner;

public class Problem_08 {
    public static void main(String[] args) {
        String sNum = new Scanner(Objects.requireNonNull(Problem_08.class.getResourceAsStream("/Problems/p08.txt"))).nextLine();
        long max = -1L;
